...
// ── Inner component (boleh pakai useSearchParams di sini) ──
function LoginForm() {
...
// ── Page utama — wrap LoginForm dengan Suspense ──
export default function LoginPage() {
  return (
    <div className="w-full max-w-md">
      ...
      <Suspense fallback={
        <div className="bg-white border border-grey-200 rounded-xl shadow-sm p-8 text-center text-sm text-grey-400">
          Memuat...
        </div>
      }>
        <LoginForm />
